...
### Creating the Openshift/Kubernetes manifest
    ...
    [root@bastion ~]# ./openshift-install create manifests --dir lab/
...
- coreos-installer install /dev/sda --ignition-url http://192.168.1.4/ocp4/bootstrap.ign --insecure --insecure-ignition --copy-network 
